...
# Make symlinks
ln -sf /goinfre/hrizkiou/docker/com.docker.docker ~/Library/Containers/com.docker.docker
ln -sf /goinfre/hrizkiou/docker/com.docker.helper ~/Library/Containers/com.docker.helper
ln -sf /goinfre/hrizkiou/docker/.docker ~/.docker
...
mkdir -p /goinfre/hrizkiou/docker/{com.docker.{docker,helper},.docker} 
/goinfre/$USER/docker

ln -sf /goinfre/hrizkiou/music ~/Music